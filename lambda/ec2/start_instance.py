"""
Start a stopped Amazon EC2 instance using boto3.
...
def start_instance(instance_id: str) -> Dict[str, Any]:
    ...
    logger.info("Starting instance %s (previous state: %s)", instance_id, state_change["PreviousState"]["Name"])
    return {
...
def lambda_handler(event: Dict[str, Any], context: Any) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            "statusCode": 200,
            "body": json.dumps({"message": "Start initiated successfully", **result}),
        }
